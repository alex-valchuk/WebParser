...
namespace Searcher.Lib
{
    ...
    public class ShopItem : ISearchItem, IXmlSerializable
    {
        ...
        private IList<String> excludedPathList;
        ...
        /// <summary>
        /// Get list of excluded path from search
        /// </summary>
        public IList<String> ExcludedPathList
        {
            get { return excludedPathList; }
        }
        ...
        internal ShopItem()
        {
            this.excludedPathList = new List<String>();
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            reader.ReadStartElement("ExcludedPathList");
            while (reader.Name == "ExcludedPath")
            {
                String path = reader.ReadElementString("ExcludedPath");
                this.excludedPathList.Add(path);
            }
            if (reader.Name == "ExcludedPathList")
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteStartElement("ExcludedPathList");
            foreach (String path in excludedPathList)
            {
                writer.WriteElementString("ExcludedPath", path);
            }
